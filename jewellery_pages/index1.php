   ...
   <body id="home_page" class="home_page">
           ...
           <div class="container">
              <div class="row">
               <div class="col-lg-3">
                  <div class="full">
                     <div class="logo">
                        <a href="index1.php"><img src="images\srlogo1.jpg" alt="#" /></a>
                     </div>
                  </div>
               </div>
               <div class="col-lg-9 site_information">
                  <div class="full">
                      <div class="top_section_info">
                         <ul>
                           <li>Contact Us: <img src="images/i1.png" alt="#" /> <a href="#">( +91 9206033669 )</a></li>
                           <li><img src="images/i2.png" alt="#" /> <a href="#">tejalrk3132@gmail.com</a></li>
                           <li><img src="images/i3.png" alt="#" /> <a href="https://maps.app.goo.gl/PydRrgJ9FbLcAL4u9?g_st=iw">121, DVG Road, BLR-560004</a></li>
                        </ul>
                      </div>
                  </div>
               </div>
                        ...
                        <div class="container">
                           <div class="row">
                              <div class="slider_coint_inner">
                                 ...
                                 <h4 style="color : #28EBAA;" class="font_themecolor">Premium Jewellery</h4>
                                 <p>Specialised in Gems, Diamonds, Gold and Silver</p>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <div class="full">
                     <p class="large">We are a trusted Jewellery Empire since 1960 with costumisable Jewellery crafted with perfection.</p>
                  </div>
               </div>
               <div class="col-md-12">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <div class="full">
                     <p class="large">DIAMONDS.GEMS.GOLD.SILVER</p>
                  </div>
               </div>
            </div>
            <div class="row product_section">
               <!-- <div class="col-md-4"> 
                  <div class="full product_blog margin_top_30">
                     ...
                     <h3><span style="color: #72dd78 !important;"> ₹50000</span> Ruby ring</h3>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="full product_blog margin_top_30">
                     <img src="images/pro2.jpg" alt="#" />
                     <h3><span style="color: #72dd78 !important;"> ₹25000</span> Wedding ring</h3>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="full product_blog margin_top_30">
                     <img src="images/pro3.jpg" alt="#" />
                     <h3><span style="color: #72dd78 !important;"> ₹30000</span> Coral ring</h3>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="full product_blog margin_top_30">
                     <img src="images/pro3.jpg" alt="#" />
                     <h3><span style="color: #72dd78 !important;"> ₹35000</span> Emrald ring</h3>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="full product_blog margin_top_30">
                     <img src="images/pro4.jpg" alt="#" />
                     <h3><span style="color: #72dd78 !important;"> ₹55000</span> Diamond ring</h3>
                  </div>
               </div> -->
               <div class="col-md-4">
                  <div class="full product_blog margin_top_30">
                     <img src="prod_images\brac_1.jpg" alt="#" />
                     <h3><span style="color: #72dd78 !important;"> ₹60000</span> Couple rings</h3>
                  </div>
               </div> 
               <?php
                  require 'connection\connection.php';
                  $query = $conn->query("SELECt * FROM bracelet ;");
                  while($row = $query->fetch_array())
                  {
                     ...
                     <div class="col-md-4"> 
                        <div class="full product_blog margin_top_30">
                           ...
                           <h3><span style="color: #72dd78 !important;">₹<?php echo row['b_cost'];?></span> <?php echo row['prod_name'];?> <span style="color: #72dd78 !important;">PIN:<?php echo row['b_prod_id'];?></span></h3>
                        </div>
                   </div>
                     <?php
                  }
                   ...
                   <div class="container">
                    <div class="col-md-8">
                     <div class="full banner_section">
                         ...
                         <p>We are a trusted Jewellery Empire since 1960 with costumisable Jewellery crafted with perfection.</p>
                     </div>
                    </div>
                 </div>
                  </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-3 col-sm-12">
                  <a href="index1.php"><img class="img-responsive" src="images\srlogo1.jpg" alt="#" /></a>
               </div>
               ...
               <div class="col-md-3 col-sm-12">
                  ...
                  <div class="address_infor">
                     <p> 
                        ...
                        <span class="addrs">121, DVG Road, BLR-560004</span>
                     </p>
                  </div>
               </div>
      ...
      <div class="cpy">
        <div class="container">
           <div class="row">
             <div class="col-md-12">
               <p>© 2019 All Rights Reserved. <a href="https://html.design/"></a></p>
             </div>
           </div>
        </div>
      </div>
